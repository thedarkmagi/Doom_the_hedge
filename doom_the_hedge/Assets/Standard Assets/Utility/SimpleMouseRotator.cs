...
namespace UnityStandardAssets.Utility
{
    public class SimpleMouseRotator : MonoBehaviour
    {
        ...
        public Vector2 rotationmodifierX;
        ...
        private void Update()
        {
			...
			if (autoZeroVerticalOnMobile) {
                ...
                m_TargetAngles.y = Mathf.Clamp(m_TargetAngles.y, (-rotationRange.y + rotationmodifierX.x )* 0.5f, (rotationRange.y + rotationmodifierX.x) * 0.5f);
